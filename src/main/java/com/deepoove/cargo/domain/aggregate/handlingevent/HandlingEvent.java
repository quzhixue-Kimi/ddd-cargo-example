...
public class HandlingEvent {
  ...
  public static HandlingEvent newHandlingEvent(String cargoId, Date time, EventTypeEnum eventType, String scheduleId) {
    return newHandlingEvent(UUID.randomUUID().toString(), cargoId, time, eventType, scheduleId);
  }

  public static HandlingEvent newHandlingEvent(String id, String cargoId, Date time, EventTypeEnum eventType,
      String scheduleId) {
